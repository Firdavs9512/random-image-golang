...
<body class="bg-black muli">
    <nav class="w-100pc flex flex-column md-flex-row md-px-10 py-5 bg-black">
        ...
        <div id="nav-items" class="hidden flex sm-w-100pc flex-column md-flex md-flex-row md-justify-end items-center">
            ...
            <a href="#slider-1" class="fs-s1 mx-3 py-3 indigo no-underline hover-underline">API</a>
            <a href="#blog" class="fs-s1 mx-3 py-3 indigo no-underline hover-underline">Blog</a>
            <a href="#slider-1" class="button bg-white black fw-600 no-underline mx-5">Register</a>
        </div>
    </nav>
    ...
    <section id="home" class="min-h-100vh flex justify-start items-center">
        <div class="mx-5 md-mx-l5">
            <div class="inline-block br-round bg-indigo-30 indigo-lightest p-2 fs-s2 mb-5">
                <div class="inline-block bg-indigo indigo-lightest br-round px-3 py-1 mr-3 fs-s3">LIKE & SHARE</div>to keep our generators available ... 
            </div>
            <div>
                <h1 class="white fs-l3 lh-2 md-fs-xl1 md-lh-1 fw-900 ">Free Api <br />Fast Website</h1>
        ...
        <div class="flex flex-column md-flex-row mx-auto">
            <div class="w-100pc md-w-40pc">
                <div class="br-8 p-5 m-5">
                    ...
                    <div class="indigo-lightest fw-600 fs-m1 lh-3 opacity-50">There are about 10,000 images on the website. 
                        All this is free and you can use it anywhere. Any kind of pictures are available.</div>
                    <a href="#"
            ...
            <div class="w-100pc md-w-40pc">
                <div class="br-8 p-5 m-5">
                    ...
                    <div class="indigo-lightest fw-600 fs-m1 opacity-50">About 1000 requests are received per second and all of them are answered. We offer you fast api service. Use it for your own websites.</div>
                    <a href="#"
                        class="mt-5 button bg-indigo-lightest-10 fs-s3 white no-underline hover-opacity-100 hover-scale-up-1 ease-300">Read</a>
                </div>
            </div>
            <div class="w-100pc md-w-40pc">
                <div class="br-8 p-5 m-5">
                    ...
                    <div class="indigo-lightest fw-600 fs-m1 opacity-50">All information is stored securely. We will not share your information with anyone. The API is written in the php programming language.</div>
                    <a href="#"
                        class="mt-5 button bg-indigo-lightest-10 fs-s3 white no-underline hover-opacity-100 hover-scale-up-1 ease-300">Read</a>
                </div>
            </div>
    ...
    <section class="relative bg-indigo-lightest-10">
        <div id="slider-1">
            <div class="p-10 md-p-l10 flex justify-center items-center flex-column text-center">
                ...
                <p class="indigo-lightest fw-600 fs-m1 opacity-30 my-5">GET -> https://{{ . }}/api/image </p>
                <a href="#" onclick="copyToClipboard('https://{{ . }}/api/image')" class="button-md bg-indigo white fs-s3 br-4 black fw-600 no-underline m-5">COPY LINK</a>
            </div>
            <div class="p-10 md-p-l10 flex justify-center items-center flex-column text-center">
                <h2 class="white fs-l3 fw-900">All desktop view images in one place.</h2>
                <p class="indigo-lightest fw-600 fs-m1 opacity-30 my-5">GET -> https://{{ . }}/api/desktop</p>
                <a href="#" onclick="copyToClipboard('https://{{ . }}/api/image')" class="button-md bg-indigo white fs-s3 br-4 black fw-600 no-underline m-5">COPY LINK</a>
            </div>
            <div class="p-10 md-p-l10 flex justify-center items-center flex-column text-center">
                <h2 class="white fs-l3 fw-900">All mobile view images in one place.</h2>
                <p class="indigo-lightest fw-600 fs-m1 opacity-30 my-5">GET -> https://{{ . }}/api/mobile </p>
                <a href="#" onclick="copyToClipboard('https://{{ . }}/api/image')" class="button-md bg-indigo white fs-s3 br-4 black fw-600 no-underline m-5">COPY LINK</a>
            </div>
        </div>
    ...
    <section class="p-10 md-py-10">
        <div class="w-100pc md-w-70pc mx-auto py-10">
            <h2 class="white fs-l2 md-fs-xl1 fw-900 lh-2">
                All category images <span class="border-b bc-indigo bw-4"> one website</span> and free api service </h2>
        </div>
    </section>
            ...
            <div class="w-100pc md-w-50pc">
                <div class="br-8 p-5 m-5 bg-indigo-lightest-10 pointer hover-scale-up-1 ease-300">
                    <div class="inline-block bg-indigo indigo-lightest br-3 px-4 py-1 mb-10 fs-s4 uppercase">
                        individual</div>
                    <div class="indigo-lightest fw-600 fs-m1">Free API <span class="opacity-30">  service, all our services are free and quality. Whatever help you need, we can help. You can contact us.</span> </div>
                    <a href="#" class="mt-10 button bg-black fs-s3 white no-underline">Contact</a>
                </div>
            </div>
            <div class="w-100pc md-w-50pc">
                <div class="br-8 p-5 m-5 bg-indigo-lightest-10  pointer hover-scale-up-1 ease-300">
                    <div class="inline-block bg-indigo indigo-lightest br-3 px-4 py-1 mb-10 fs-s4 uppercase">
                        team</div>
                    <div class="indigo-lightest fw-600 fs-m1">Our team<span class="opacity-30">  provides all kinds of services. We can offer you quality, fast and reliable services. If you want to apply, send an email and we will contact you.</span> </div>
                    <a href="#" class="mt-10 button bg-black fs-s3 white no-underline">Contact</a>
    ...
    <section id="pricing">
        <div class="p-10 flex flex-wrap">
            <div class="w-100pc md-w-50pc">
                <div class="p-5">
                    <h4 class="white fw-800 fs-l3 mb-5">API Pricing</h4>
                    <div class="indigo-lightest fw-600 fs-m1 opacity-50">All category images one website and free api service. There are about 10,000 images on the website. The API is written in the php programming language.</div>
                ...
                <div class="m-3 p-5 br-8 bg-indigo-lightest-10 overflow-hidden">
                    ...
                    <div class="p-3 indigo-lightest fw-400 fs-s1 lh-5">
                        <div>
                            ...
                            <span class="opacity-50">10GB Images</span>
                        </div>
                        <div>
                            <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                            <span class="opacity-50">1000 visitors/week</span></div>
                        <div>
                            <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                            <span class="opacity-50">Many website</span></div>
                        <div>
                            <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                            <span class="opacity-50">24x7 support</span></div>
                        <div>
                            <i class="h-3" stroke-width="4" data-feather="x"></i>
                            <span class="opacity-50">size edit version</span></div>
                    </div>
                    <div class="p-3">
                        <a href="#slider-1" class="button full bg-black no-underline white  hover-opacity-100 hover-scale-up-1 ease-300">USE API</a>
                    </div>
                </div>
            </div>
            <div class="w-100pc md-w-25pc">
                <div class="m-3 p-5 br-8 bg-white overflow-hidden">
                    <div class="p-3">
                        ...
                        <div class="black flex items-center">$<span class="fs-l5 lh-1">0</span>/mo</div>
                    </div>
                    <div class="p-3 black fw-400 fs-s1 lh-5">
                        <div>
                            <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                            <span class="opacity-50"> 50GB Images</span></div>
                        <div>
                            <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                            <span class="opacity-50">10,000 visitors/week</span></div>
                        <div>
                            <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                            <span class="opacity-50">Many website</span></div>
                        <div>
                    ...
                    <div class="p-3">
                        <button class="button full bg-indigo white hover-opacity-100 hover-scale-up-1 ease-300">COMING SOON</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="slider-2">
            <div class="px-3">
                <div class="p-8 br-8 bg-indigo-lightest-10 relative">
                    ...
                    <p class="fw-600 fs-m1 indigo-lightest opacity-80 italic ls-wider">Very convenient site. I tried it and I really liked it. I recommend you too.</p>
                    <div class="flex items-center my-5">
                        <div class="block br-round border bc-black bw-4 w-l3 h-l3"><img class="br-round"
                                src="https://randomuser.me/api/portraits/men/45.jpg" alt=""></div>
            ...
            <div class="px-3">
                <div class="p-8 br-8 bg-indigo-lightest-10 relative">
                    <span class="fs-l5 lh-1 white opacity-10 absolute top-0 z--1">&#10077;</span>
                    <p class="fw-600 fs-m1 indigo-lightest opacity-80 italic ls-wider">This site is still new, but it works very well. We are waiting for the next versions. </p>
                    <div class="flex items-center my-5">
                        <div class="block br-round border bc-black bw-4 w-l3 h-l3"><img class="br-round"
                                src="https://randomuser.me/api/portraits/men/44.jpg" alt=""></div>
                        <div class="ml-4 fs-s1">
                            <div class="indigo-lightest">Kevin M. Stuckey</div>
                            <div class="indigo-lightest opacity-20">Merrymaking</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="px-3">
                <div class="p-8 br-8 bg-indigo-lightest-10 relative">
                    <span class="fs-l5 lh-1 white opacity-10 absolute top-0 z--1">&#10077;</span>
                    <p class="fw-600 fs-m1 indigo-lightest opacity-80 italic ls-wider">An api for all images is in development. I love that it's all free. </p>
                    <div class="flex items-center my-5">
                        <div class="block br-round border bc-black bw-4 w-l3 h-l3"><img class="br-round"
                                src="https://randomuser.me/api/portraits/men/43.jpg" alt=""></div>
                        <div class="ml-4 fs-s1">
                            <div class="indigo-lightest">Peter A. Reed</div>
                            <div class="indigo-lightest opacity-20">Service Merchandise</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="px-3">
                <div class="p-8 br-8 bg-indigo-lightest-10 relative">
                    <span class="fs-l5 lh-1 white opacity-10 absolute top-0 z--1">&#10077;</span>
                    <p class="fw-600 fs-m1 indigo-lightest opacity-80 italic ls-wider">I used all the services on this site. I liked it. I intend to cooperate now.</p>
                    <div class="flex items-center my-5">
                        <div class="block br-round border bc-black bw-4 w-l3 h-l3"><img class="br-round"
                                src="https://randomuser.me/api/portraits/men/42.jpg" alt=""></div>
                        <div class="ml-4 fs-s1">
                            <div class="indigo-lightest">James R. Serrano</div>
                            <div class="indigo-lightest opacity-20">K&G Distributors</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="p-10 md-p-l10">
        <div class="md-w-75pc">
            <h2 class="white fs-l3 fw-900 lh-1">All pictures are for you</h2>
        ...
        <div id="blog" class="flex flex-wrap">
            <div class="w-100pc md-w-33pc p-10">
                <a href="#" class="block no-underline p-5 br-8 hover-bg-indigo-lightest-10 hover-scale-up-1 ease-300">
                    ...
                    <img class="w-100pc" src="http://{{ . }}/api/image" alt="">
            ...
            <div class="w-100pc md-w-33pc p-10">
                <a href="#" class="block no-underline p-5 br-8 hover-bg-indigo-lightest-10 hover-scale-up-1 ease-300">
                    <img class="w-100pc" src="http://{{ . }}/api/mobile" alt="">
                    <p class="fw-600 white fs-m3 mt-3">
            ...
            <div class="w-100pc md-w-33pc p-10">
                <a href="#" class="block no-underline p-5 br-8 hover-bg-indigo-lightest-10 hover-scale-up-1 ease-300">
                    <img class="w-100pc" src="http://{{ . }}/api/desktop" alt="">
                    <p class="fw-600 white fs-m3 mt-3">
        ...
        <div class="flex flex-wrap">
            <div class="md-w-25pc mb-10">
                ...
                <div class="white opacity-70 fs-s2 mt-4 md-pr-10">
                    ...
                    <br>
                    <p>One of the best aspects of this free image tool is that you can determine the exact number of random pictures you want to see at one time.</p>
                </div>
            </div>
            <div class="w-100pc md-w-50pc">
    ...
    <a class="fixed top-50pc right-0 p-2 bg-indigo white hover-scale-up-1 ease-300 no-underline" href="https://github.com/firdavs9512" target="_blank" >
        <i class="w-4" data-feather="github"></i>
    </div>
    <script>
